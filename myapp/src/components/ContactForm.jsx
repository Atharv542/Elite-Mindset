    ...
    >
      ...
      >
        ...
        <motion.form
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="bg-neutral-900/80 backdrop-blur rounded-3xl p-8 md:p-12 space-y-6 border border-gray-800"
        >
          {[
            ...
            <motion.div key={f.name} variants={item}>
              ...
              <input
                ...
                className="w-full bg-black/50 text-white rounded-xl px-4 py-3 border border-gray-700 focus:border-cyan-400 focus:outline-none transition-all placeholder-gray-500"
              />
            </motion.div>
          ))}
          ...
          <motion.div variants={item}>
            ...
            <select
              ...
              onChange={handleChange}
              required
              className="w-full bg-black/50 text-white rounded-xl px-4 py-3 border border-gray-700 focus:border-cyan-400 focus:outline-none transition-all"
            >
              <option value="">Select package</option>
              <option value="partnership">Partnership – 15,000 AED (30 workshops)</option>
              <option value="individual">Individual Coaching – 48,000 AED</option>
            </select>
          </motion.div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-black font-bold py-4 rounded-full"
          >
