  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-neutral-950 via-neutral-900 to-black px-6 py-24 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-20 flex items-center gap-3 text-sm text-gray-400">
        ...
        <span>/</span>
        <span className="text-cyan-400">{workshop.title}</span>
      </div>
      ...
      <div className="absolute left-1/2 -translate-x-[520px] top-[320px] bottom-[200px] hidden lg:block">
        <div className="w-px h-full bg-gradient-to-b from-cyan-500/40 via-cyan-500/20 to-transparent" />
      </div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-6 mb-8">
              <span className="text-5xl font-bold text-cyan-400/60">
      ...
      <div className="text-center mt-32">
        <button
          onClick={() => navigate(-1)}
          className="px-10 cursor-pointer py-4 rounded-full border border-cyan-400 text-cyan-400 hover:bg-cyan-400/10 transition"
        >
          Back to Workshops
        </button>
      </div>
